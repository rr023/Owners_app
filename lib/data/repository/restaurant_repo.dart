...
class RestaurantRepo {
  ...
  Future<Response> updateRestaurant(Restaurant restaurant, XFile logo, XFile cover, String token) async {
    ...
    _fields.addAll(<String, String>{
      ...
      'veg': restaurant.veg.toString(), 'non_veg': restaurant.nonVeg.toString(),
    });
    if(restaurant.minimumShippingCharge != null && restaurant.perKmShippingCharge != null) {
      _fields.addAll(<String, String>{
  ...
  Future<Response> addProduct(Product product, XFile image, bool isAdd) async {
    Map<String, String> _fields = Map();
    _fields.addAll(<String, String>{
