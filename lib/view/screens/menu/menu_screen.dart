...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<MenuModel> _menuList = [
      ...
      MenuModel(icon: Images.chat, title: 'conversation'.tr, backgroundColor: Color(0xFF62889C), route: RouteHelper.getConversationListRoute(),
    ...
    if(Get.find<AuthController>().profileModel.subscription != null) {
      _menuList.insert(10, MenuModel(
        icon: Images.subscription, title: 'my_subscription'.tr, backgroundColor: Color(0xFF62889C), route: RouteHelper.getSubscriptionViewRoute(),
      ));
    }
