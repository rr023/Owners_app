      ...
      Row(children: [
        ...
        Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          fromRestaurant ? Text(
            ...
            maxLines: 1, overflow: TextOverflow.ellipsis,
            style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: review.customer != null ? Theme.of(context).textTheme.headline1 : Theme.of(context).disabledColor),
          ) : SizedBox(),
          SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
