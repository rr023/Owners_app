...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(Get.find<AuthController>().profileModel.restaurants[0].restaurantModel == 'subscription'){
      _haveSubscription = Get.find<AuthController>().profileModel.subscription.review == 1;
    }else{
        ...
        return Column(children: [
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              (product.variations != null && product.variations.length> 0) ? Text('variations'.tr, style: robotoMedium) : SizedBox(),
              SizedBox(height: (product.variations != null && product.variations.length> 0) ? Dimensions.PADDING_SIZE_EXTRA_SMALL : 0),
              (product.variations != null && product.variations.length> 0) ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        Text('${product.variations[index].name +' - '}', style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                        Text(
              ...
              SizedBox(height: (product.variations != null && product.variations.length> 0) ? Dimensions.PADDING_SIZE_LARGE : 0),
              ...
              Get.find<AuthController>().profileModel.restaurants[0].reviewsSection ? Column(
                ...
                children: [
                  ...
                  _haveSubscription ? restController.productReviewList != null ? restController.productReviewList.length > 0 ? ListView.builder(
