    ...
    return InkWell(
      ...
      child: Stack(clipBehavior: Clip.none, children: [
        ...
        Container(
          ...
          child: Center(child: Text(title, style: robotoMedium.copyWith(color: authController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyText1.color, fontSize: Dimensions.FONT_SIZE_DEFAULT))),
        ),
